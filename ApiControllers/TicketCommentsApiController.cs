...
//            {
//                TicketId = ticketId,
//                UserId = currentUserId, // Using UserId property as per TicketComment model
//                CommentText = createDto.CommentText.Trim(),
...
//            comment.CommentText = updateDto.CommentText.Trim();
...
//            // Check if the current user is the owner of the comment OR an Admin
//            if (comment.CreatedBy.Id != currentUserId && !User.IsInRole("Admin"))
//            {
